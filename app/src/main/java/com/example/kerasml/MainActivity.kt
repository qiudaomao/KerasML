...
class MainActivity : AppCompatActivity() {
    ...
    fun runInference() {
        ...
        runOnUiThread {
//            binding.results.text = "Prediction $prediction"
//            print("Prediction $prediction")
            Log.d("ML", "Prediction $prediction")
        }
    }
...
//        val fileDescriptor = activity.assets.openFd("trained_model.tflite")
        val fileDescriptor = activity.assets.openFd("model2.tflite")
